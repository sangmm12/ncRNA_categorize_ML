...
def main():
    ...
    if args.do_umap:
        try:
            # Compatibility shim for umap-learn 0.5.x with newer scikit-learn.
            # Newer sklearn replaced/removed the old force_all_finite argument.
            import sklearn.utils.validation as skv
            _orig_check_array = skv.check_array

            def _check_array_compat(*a, **kw):
            ...
            skv.check_array = _check_array_compat
